...
const ModifyCourse = () => {
       ...
       const { 
           ...
           deleteFromList, 
           handleOnSubmit,
           handleInputOnChangeList} = useHelper();
                        ...
                        <label>
                            ...
                            <div className={styles.select}>
                                <select 
                                 ...
                                 >
                                    <option value="default" disabled>Seleccionar Alumno</option>
                                {students?.map((s: any) => <option key={`${s.name.first}${s.name.last}key`}>{`${s.name.first} ${s.name.last}`}</option>)}
                                </select>
                            </div>
                    ...
                    <div className={styles.teachersContainer}>
                        <label>
                            ...
                            <div className={styles.select}>
                                ...
                                onChange={handleInputOnChangeList}
                                >
                                    <option value="default" disabled>Seleccionar Profesor</option>
                                {teachers.map((t: any) => <option>{`${t.name.first} ${t.name.last}`}</option>)}
                                </select>
                            </div>
                        </label>
                        <div className={styles.tables}>
                    ...
                    <div className={styles.subjectsContainer}>
                        <label>
                            ...
                            <div className={styles.select}>
                                ...
                                {subjects.map((subject: any) => <option key={subject.name}>{subject.name}</option>)}
                                </select>
                            </div>
                            <div className={styles.tables}>
                                    <ul>
